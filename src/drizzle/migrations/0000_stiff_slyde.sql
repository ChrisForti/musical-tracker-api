...
ALTER TABLE "performance" ADD CONSTRAINT "performance_production_id_production_id_fk" FOREIGN KEY ("production_id") REFERENCES "public"."production"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
