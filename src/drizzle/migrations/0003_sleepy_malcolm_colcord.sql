ALTER TABLE "musical" DROP COLUMN "poster_url";--> statement-breakpoint
ALTER TABLE "performance" DROP COLUMN "poster_url";--> statement-breakpoint
ALTER TABLE "musical" ADD COLUMN "poster_id" uuid;--> statement-breakpoint
ALTER TABLE "performance" ADD COLUMN "poster_id" uuid;--> statement-breakpoint
