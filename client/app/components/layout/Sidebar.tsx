          ...
          <ul className="space-y-2">
            ...
            <li>
              ...
              >
                ...
                {(isExpanded || isHovered) && <span>Search & Filter</span>}
              </button>
            </li>

            {/* Management Section - User Content */}
            {user && (
              <li>
                <div className="px-4 py-2">
                  {(isExpanded || isHovered) && (
                ...
                >
                  <div className="flex items-center">
                    ...
                    {(isExpanded || isHovered) && <span>Manage</span>}
                  </div>
                  {(isExpanded || isHovered) && (
                    <svg
                      className={`w-4 h-4 transition-transform ${openSubmenu === "manage" ? "rotate-180" : ""}`}
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                ...
                {openSubmenu === "manage" && (isExpanded || isHovered) && (
